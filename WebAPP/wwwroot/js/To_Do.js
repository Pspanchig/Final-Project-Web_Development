document.addEventListener('DOMContentLoaded', () => {
    // Corrected currentUser usage, assuming getCurrentUser returns an object with a username property
...
function getCurrentUser() {
    ...
    if (userData) {
        // Parse the user data back into an object and return it
        return JSON.parse(userData);
    } else {
        // If there is no current user data in localStorage, return null or a default object
        return null;
    }
}
